 ...
 * Excludes all ticket JSON files but keeps the gitignore itself trackable, so
 * teams who commit `.vscode/` see why their tickets are absent.
 */
export const GITIGNORE_CONTENT =
  "# Auto-generated by DoStuff. Ticket files are local to this clone.\n*\n!.gitignore\n";
...
export class IssueStore {
  ...
  /**
   * Write a `.gitignore` inside the storage folder so ticket JSON files are
   * excluded from Git even when `.vscode/` itself is tracked. Idempotent and
